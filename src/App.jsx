...
import { SiMaildotru, SiTailwindcss } from "react-icons/si";
...
const elements = [
  ...
  },
  {
    ...
    text: "An application that allows you to manage hotel rooms: Styled Components, React Router Dom v6, React Query, work with supabase, Context Api: Login:test@example.com Pass:qwe12345. Version in development",
